...
Server 作为游戏引擎，涉及 D&D 5e 规则的实现必须严格遵循官方规则书。规则不确定时禁止猜测实现，必须查阅规则书或请求人工介入。详见本文档的 **D&D 5e 规则实现要求** 章节。
...
**重要**: MCP Server 的实现涉及 D&D 5e 规则时，必须严格遵循官方规则书。

### 规则书资源

规则书位于 `docs/dnd5e规则书/` 目录，查询指南见 `docs/dnd5e规则书/查询指南.md`。
...
3. **模糊点人工介入**: 当规则书描述模糊或存在歧义时，必须暂停并询问用户如何处理，提供选项说明
...
- **docs/dnd5e规则书/查询指南.md** - 规则书查询索引，按主题分类的快速定位指南
- **5eDnD_玩家手册PHB_中译v1.72版.pdf** - 核心规则：角色、战斗、法术
- **5eDnD_城主指南_中译v1.1.pdf** - DM规则、魔法物品、遭遇设计
- **5eDnD_怪物图鉴MM_中译 v1.3（纯文字）.pdf** - 怪物数据
