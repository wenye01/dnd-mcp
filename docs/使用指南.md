...
- [代码规范](代码规范.md) - 编码规范
- [整体架构设计](整体架构设计.md) - 技术架构
- [Client 详细设计](client/详细设计.md) - Client 技术设计
- [Server 详细设计](server/详细设计.md) - Server 技术设计
- [Server 开发计划](server/plan/README.md) - 开发里程碑和任务

## 下一步

MCP Client 已完成，当前正在开发 MCP Server。详见 [Server 开发计划](server/plan/README.md)
