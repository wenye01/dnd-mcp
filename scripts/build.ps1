# DND MCP Client Build Script (Windows PowerShell)
# -*- coding: utf-8 -*-

[Console]::OutputEncoding = [System.Text.Encoding]::UTF8
$OutputEncoding = [System.Text.Encoding]::UTF8

Write-Host "Building DND MCP Client..." -ForegroundColor Green
...
go build -ldflags $Ldflags -o "$BuildDir\$AppName.exe" ./cmd/client
